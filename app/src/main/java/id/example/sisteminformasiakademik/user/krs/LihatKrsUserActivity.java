...
public class LihatKrsUserActivity extends AppCompatActivity {

    TextView txtdate, txtNamaLihatKrs, txtNimLihatKrs, txtProdi, txtSemester, txtmatkul1, txtsks1, txtmatkul2, txtsks2, txtmatkul3, txtsks3, txtmatkul4, txtsks4, txtmatkul5, txtsks5, txtmatkul6, txtsks6, txtmatkul7, txtsks7, txtmatkul8, txtsks8, txtjumlahsks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lihat_krs_user);
        getSupportActionBar().hide();
        fn_permission();

        btnSimpanKrs = findViewById(R.id.btnSimpanKrsPDF);
        txtNimLihatKrs = findViewById(R.id.txtNimLihatKRSuser);
        txtNamaLihatKrs = findViewById(R.id.txtNamaLihatKRSuser);
        txtProdi = findViewById(R.id.txtprodiLihatKrs);
        txtSemester = findViewById(R.id.txtsemesterLihatKrs);
        txtmatkul1 = findViewById(R.id.tvMatkul1);
        txtsks1 = findViewById(R.id.tvSks1);
        txtmatkul2 = findViewById(R.id.tvMatkul2);
        txtsks2 = findViewById(R.id.tvSks2);
        txtmatkul3 = findViewById(R.id.tvMatkul3);
        txtsks3 = findViewById(R.id.tvSks3);
        txtmatkul4 = findViewById(R.id.tvMatkul4);
        txtsks4 = findViewById(R.id.tvSks4);
        txtmatkul5 = findViewById(R.id.tvMatkul5);
        txtsks5 = findViewById(R.id.tvSks5);
        txtmatkul6 = findViewById(R.id.tvMatkul6);
        txtsks6 = findViewById(R.id.tvSks6);
        txtmatkul7 = findViewById(R.id.tvMatkul7);
        txtsks7 = findViewById(R.id.tvSks7);
        txtmatkul8 = findViewById(R.id.tvMatkul8);
        txtsks8 = findViewById(R.id.tvSks8);
        txtjumlahsks = findViewById(R.id.tvJumlahsks);
        txtdate = findViewById(R.id.dateKrs);

        btnSimpanKrs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                progressDialog = new ProgressDialog(LihatKrsUserActivity.this);
    ...
    public void onBackPressed() {
        String nimData = txtNimLihatKrs.getText().toString().trim();
        String namaData = txtNamaLihatKrs.getText().toString().trim();
    ...
    public void moveToIsiKRSLihat(View view) {
        String nimData = txtNimLihatKrs.getText().toString().trim();
        String namaData = txtNamaLihatKrs.getText().toString().trim();
        Intent intent = new Intent(getApplicationContext(), IsiKrsActivity.class);
        intent.putExtra("nim", nimData);
    ...
    private void printKRS() {
        ...
        String path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/KRS UNPI/";
        ...
        try {
            ...
            boolean_save=true;
            Toast.makeText(this, "PDF Tersimpan Di Penyimpanan Internal/Download/KRS UNPI", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void fn_permission() {
        if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) ||
            ...
            if ((ActivityCompat.shouldShowRequestPermissionRationale(LihatKrsUserActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE))) {
            } else {
                ActivityCompat.requestPermissions(LihatKrsUserActivity.this, new String[]{android.Manifest.permission.READ_EXTERNAL_STORAGE},
                        REQUEST_PERMISSIONS);

            }

            if ((ActivityCompat.shouldShowRequestPermissionRationale(LihatKrsUserActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE))) {
            } else {
                ActivityCompat.requestPermissions(LihatKrsUserActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                        REQUEST_PERMISSIONS);
