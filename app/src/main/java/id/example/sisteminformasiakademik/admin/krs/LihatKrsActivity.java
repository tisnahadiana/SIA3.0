...
import id.example.sisteminformasiakademik.user.krs.LihatKrsUserActivity;
...
public class LihatKrsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtIdAdminKRS = findViewById(R.id.txtIdAdminKRSlihatkrs);
        txtNamaAdminKRS = findViewById(R.id.txtNamaAdminKRSlihatkrs);
        btnSimpanKrs = findViewById(R.id.btnSimpanKrsPDFadmin);
        txtNimLihatKrs = findViewById(R.id.txtNimLihatKRSadmin);
        txtNamaLihatKrs = findViewById(R.id.txtNamaLihatKRSadmin);
        txtProdi = findViewById(R.id.txtprodiLihatKrsadmin);
        txtSemester = findViewById(R.id.txtsemesterLihatKrsadmin);
        txtmatkul1 = findViewById(R.id.tvMatkul1admin);
        txtsks1 = findViewById(R.id.tvSks1admin);
        txtmatkul2 = findViewById(R.id.tvMatkul2admin);
        txtsks2 = findViewById(R.id.tvSks2admin);
        txtmatkul3 = findViewById(R.id.tvMatkul3admin);
        txtsks3 = findViewById(R.id.tvSks3admin);
        txtmatkul4 = findViewById(R.id.tvMatkul4admin);
        txtsks4 = findViewById(R.id.tvSks4admin);
        txtmatkul5 = findViewById(R.id.tvMatkul5admin);
        txtsks5 = findViewById(R.id.tvSks5admin);
        txtmatkul6 = findViewById(R.id.tvMatkul6admin);
        txtsks6 = findViewById(R.id.tvSks6admin);
        txtmatkul7 = findViewById(R.id.tvMatkul7admin);
        txtsks7 = findViewById(R.id.tvSks7admin);
        txtmatkul8 = findViewById(R.id.tvMatkul8admin);
        txtsks8 = findViewById(R.id.tvSks8admin);
        txtjumlahsks = findViewById(R.id.tvJumlahsksadmin);
        txtdate = findViewById(R.id.dateKrsadmin);

        btnSimpanKrs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                progressDialog = new ProgressDialog(LihatKrsActivity.this);
    ...
    private void printKRS() {
        ...
        String path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/Admin/KRS UNPI/";
        ...
        try {
            ...
            boolean_save=true;
            Toast.makeText(this, "PDF Tersimpan Di Penyimpanan Internal/Download/Admin/KRS UNPI", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void fn_permission() {
        if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) ||
            ...
            if ((ActivityCompat.shouldShowRequestPermissionRationale(LihatKrsActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE))) {
            } else {
                ActivityCompat.requestPermissions(LihatKrsActivity.this, new String[]{android.Manifest.permission.READ_EXTERNAL_STORAGE},
                        REQUEST_PERMISSIONS);

            }

            if ((ActivityCompat.shouldShowRequestPermissionRationale(LihatKrsActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE))) {
            } else {
                ActivityCompat.requestPermissions(LihatKrsActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                        REQUEST_PERMISSIONS);
